...
:repo: Lotus
:pyver: 3.8.10
:pyver-url: https://www.python.org/downloads/release/python-3810/
:matplotlibver: 3.5
...
image:https://img.shields.io/badge/python-3.8+-blue.svg[python]

To run Lotus https://www.python.org/[`Python`] is required. Either install the https://www.python.org/downloads/[`latest version`] or use the recommended version {pyver-url}[`{pyver}`].
